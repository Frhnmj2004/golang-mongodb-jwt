...
import (
	...
	//"github.com/Frhnmj2004/golang-jwt-project/helpers"
	helper "github.com/Frhnmj2004/golang-jwt-project/helpers"
	"github.com/Frhnmj2004/golang-jwt-project/models"
...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			log.Panic(err)
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while searching for the user email"})
		}
		...
		if err != nil {
			log.Panic(err)
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while searching for the user phone"})
		}
